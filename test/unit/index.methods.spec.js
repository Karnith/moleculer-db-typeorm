...
describe("Test DbService methods", () => {
	...
	describe("Test `_create` method", () => {
		it("should call adapter.insert", () => {
			...
			service.validateEntity = jest.fn((entity) =>
			...
			return service
				...
				.then((res) => {
					...
					expect(service.beforeEntityChange).toHaveBeenCalledWith(
						"create",
						p,
						Context
					);
		...
		it("should call adapter.insert", () => {
			...
			return service
				...
				.then((res) => {
					...
					expect(service.validateEntity).toHaveBeenCalledTimes(1);
					expect(service.validateEntity).toHaveBeenCalledWith(
						p.entity
					);
