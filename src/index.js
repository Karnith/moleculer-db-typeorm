...
module.exports = {
	...
	created() {
		...
		switch (this.schema.mode.toLowerCase()) {
			...
			case "standard":
				this.adapter.init(this.broker, this);
				this.logger.warn("Database connection set to standard. Use this.adapter to interact with the database.");
				break;
			default:
				this.adapter.init(this.broker, this);
				this.logger.warn("Database connection set to default. Use this.adapter to interact with the database.");
				break;
		}
	...
	started() {
		if (this.schema.mode.toLowerCase() == "standard") {
			...
			/* istanbul ignore next */
			return Promise.reject(new Error("Please set the store adapter in schema on!"));
		}
	},
